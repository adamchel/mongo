...
TEST(FTSMatcher, NegWild1) {
    FTSQuery q;
    ASSERT_OK(q.parse("foo -bar", "english", false, false, TEXT_INDEX_VERSION_2));
    FTSMatcher m(q,
...
TEST(FTSMatcher, NegWild2) {
    FTSQuery q;
    ASSERT_OK(q.parse("pizza -restaurant", "english", false, false, TEXT_INDEX_VERSION_2));
    FTSMatcher m(q,
                 FTSSpec(FTSSpec::fixSpec(BSON("key" << BSON("$**"
                                                             << "text")))));
...
TEST(FTSMatcher, Phrase1) {
    FTSQuery q;
    ASSERT_OK(q.parse("foo \"table top\"", "english", false, false, TEXT_INDEX_VERSION_2));
    FTSMatcher m(q,
                 FTSSpec(FTSSpec::fixSpec(BSON("key" << BSON("$**"
                                                             << "text")))));
...
TEST(FTSMatcher, ParsesUsingDocLanguage) {
    FTSQuery q;
    ASSERT_OK(q.parse("-glad", "none", false, false, TEXT_INDEX_VERSION_2));
    FTSMatcher m(q,
                 FTSSpec(FTSSpec::fixSpec(BSON("key" << BSON("x"
                                                             << "text")))));
...
TEST(FTSMatcher, MatcherDoesNotFilterStopWordsNeg) {
    FTSQuery q;
    ASSERT_OK(q.parse("-the", "none", false, false, TEXT_INDEX_VERSION_2));
    FTSMatcher m(q,
                 FTSSpec(FTSSpec::fixSpec(BSON("key" << BSON("x"
                                                             << "text")))));
...
static bool docHasPositiveTermWithCase(const std::string& doc, const std::string& search) {
    FTSQuery q;
    ASSERT_OK(q.parse(search, "english", true, false, TEXT_INDEX_VERSION_2));
    FTSMatcher m(q,
                 FTSSpec(FTSSpec::fixSpec(BSON("key" << BSON("x"
                                                             << "text")))));
